  ...
  return <>
          <div className="continar mx-auto py-16 md:mt-20">
              <div className="max-w-md md:max-w-lg mx-auto">
                    <h2 className="mb-10 text-green-600 text-3xl font-bold">Login Now:</h2>
                  ...
                  {formik.errors.password && formik.touched.password?<div className="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                    ...
                    {isLoading?<i className="fa-solid fa-spinner fa-spin"></i>:'Login'}
                     ...
                     <p className="ps-2">You have an account?<Link className="font-semibold" to={'/register'}>Register Now</Link></p>
                      </div>
                      <Link className="font-semibold text-green-600 pt-5 block" to={'/forgetpassword'}>Forget password?</Link>
                   </form>
              </div>
          </div>
  </>;
