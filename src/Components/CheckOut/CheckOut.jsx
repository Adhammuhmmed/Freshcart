...
export default function CheckOut() {
  ...
  return (
        <>
           <div className="continar mx-auto py-16 ">
              <div className="max-w-md md:max-w-lg mx-auto">
                    <h2 className="mb-10 text-green-600 text-3xl font-bold">Checkout Now:</h2>
                    ...
                    <div className="relative z-0 w-full mb-5 mt-5 group">
                      <input onChange={(e)=>setTel(e.target.value)}  type="tel" name="phone" id="phone" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-600 peer" placeholder=" "  />
                    ...
                    <div className="relative z-0 w-full mb-5 mt-5 group">
                      ...
                      <button onClick={()=>{checkoutSession()}} type="button" className="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                        Payment
                     </button>
              </div>
          </div>
